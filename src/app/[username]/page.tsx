        ...
        <div className="grow">
          <div className="my-4 flex gap-2 flex-wrap">
            {profile.member_profile.telegramUrl && (
              <SocialLink
                type="Telegram"
                link={profile.member_profile.telegramUrl}
              />
            )}
            {profile.member_profile.linkedinUrl && (
              <SocialLink
                type="LinkedIn"
                link={profile.member_profile.linkedinUrl}
              />
            )}
            {profile.member_profile.githubUrl && (
              <SocialLink
                type="GitHub"
                link={profile.member_profile.githubUrl}
              />
            )}
            {profile.member_profile.websiteUrl && (
              <SocialLink
                type="Website"
                link={profile.member_profile.websiteUrl}
              />
            )}
            {profile.member_profile.youtubeUrl && (
              <SocialLink
                type="YouTube"
                link={profile.member_profile.youtubeUrl}
              />
            )}
            {profile.member_profile.tiktokUrl && (
              <SocialLink
                type="TikTok"
                link={profile.member_profile.tiktokUrl}
              />
            )}
            {profile.member_profile.facebookUrl && (
              <SocialLink
                type="Facebook"
                link={profile.member_profile.facebookUrl}
              />
            )}
            ...
            {profile.member_profile.instagramUrl && (
              <SocialLink
                type="Instagram"
                link={profile.member_profile.instagramUrl}
              />
            )}
          </div>
